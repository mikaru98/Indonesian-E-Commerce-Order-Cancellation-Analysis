...
3. all_months_clean_2.csv  - Cleaned dataset ready for analysis
```

## Problem Background

E-commerce platforms in Indonesia face the challenge of a high order cancellation rate, which reached **13.57%** during the period from December 2023 to November 2025. This high cancellation rate directly affects revenue loss, inefficient use of logistics resources, and reduced trust from both sellers and buyers toward the platform.

This analysis aims to identify the main factors behind order cancellations, including cancellation reasons, payment methods, and shipping options. The goal is to provide actionable recommendations to reduce the cancellation rate to **12.5% or lower within the next year**.
...
* `Cancellation Reason` — Reason for cancellation provided by the buyer
* `Payment Method` — Payment method used for the order
* `Shipping Option` — Shipping service selected by the buyer
...
1. **Cancellation Reason Frequency** — Top 10 reasons for order cancellations
...
4. **Monthly Cancellation Trend** — Cancellation pattern across 24 months, from December 2023 to November 2025
...
6. **Inferential Statistics** — Mann-Whitney U Test to examine whether there is a significant difference in shipping costs between cancelled and completed orders
